...
app.setStyleSheet("""
        QWidget {background-color: #63E954;}
        QPushButton {background-color: #1A8B21; color: #002100; border-radius: 10px; font-size:30px;
                  border-style: outset; border-color: #002100}
                  """)
